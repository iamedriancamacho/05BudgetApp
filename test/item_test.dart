...
//     // totalAmountSpent += itemList[index].amount;
//     totalAmountSpent += 0;
//     final double amountLeft = itemList[index].amount - totalAmountSpent;
//     final double percent = amountLeft / itemList[index].amount;
//     return SafeArea(
//       child: Scaffold(
//         appBar: AppBar(
...
//                     child: Center(
//                         // child: Text(
//                         //   '\$${amountLeft.toStringAsFixed(2)} / \$${widget.amount}',
//                         //   style: TextStyle(
//                         //     fontSize: 20.0,
